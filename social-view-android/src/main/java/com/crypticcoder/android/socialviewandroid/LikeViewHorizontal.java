 ...
 */
public class LikeViewHorizontal extends LinearLayout {
    ...
    public interface OnClickListener {
        void onClicked(LikeViewHorizontal view);
    }

    private OnClickListener mListener;

    public LikeViewHorizontal(Context context) {
        this(context, null);
    }

    public LikeViewHorizontal(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LikeViewHorizontal(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        LayoutInflater.from(context).inflate(R.layout.social_view_android_like_view_horizontal, this);
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.LikeViewHorizontal,0, 0);
        try {
            mTextColor = a.getColorStateList(R.styleable.LikeViewHorizontal_socialViewAndroid_textColor);
            mIconSrc = a.getResourceId(R.styleable.LikeViewHorizontal_socialViewAndroid_iconSrc, -1);
            mLikedIconSrc = a.getResourceId(R.styleable.LikeViewHorizontal_socialViewAndroid_likedIconSrc, -1);
            mIconFilterColor = a.getColorStateList(R.styleable.LikeViewHorizontal_socialViewAndroid_iconFilterColor);
            mLikeViewSize = a.getInt(R.styleable.LikeViewHorizontal_socialViewAndroid_likeViewSize, SIZE_SMALL);
            mCount = a.getInt(R.styleable.LikeViewHorizontal_socialViewAndroid_count, 0);
            mCountFormat = a.getInt(R.styleable.LikeViewHorizontal_socialViewAndroid_countFormat, COUNT_FORMAT_SHORT);
        ...
        iconImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mOnClickToggle) LikeViewHorizontal.this.toggle();
                if (null != mListener) mListener.onClicked(LikeViewHorizontal.this);
            }
        });
    ...
    public LikeViewHorizontal setCount(long count) {
        this.mCount = count;
        countTextView.setText(formattedCount());
        return this;
    }
