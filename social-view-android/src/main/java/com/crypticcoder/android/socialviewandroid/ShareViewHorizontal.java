...
public class ShareViewHorizontal extends LinearLayout {
    ...
    public interface OnClickListener {
        void onClicked(ShareViewHorizontal view);
    }
    ...
    public ShareViewHorizontal(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        LayoutInflater.from(context).inflate(R.layout.social_view_android_share_view_horizontal, this);
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.ShareViewHorizontal,0, 0);
        try {
            mTextColor = a.getColorStateList(R.styleable.ShareViewHorizontal_socialViewAndroid_textColor);
            mIconSrc = a.getResourceId(R.styleable.ShareViewHorizontal_socialViewAndroid_iconSrc, -1);
            mSharedIconSrc = a.getResourceId(R.styleable.ShareViewHorizontal_socialViewAndroid_sharedIconSrc, -1);
            mIconFilterColor = a.getColorStateList(R.styleable.ShareViewHorizontal_socialViewAndroid_iconFilterColor);
            mShareViewSize = a.getInt(R.styleable.ShareViewHorizontal_socialViewAndroid_shareViewSize, SIZE_SMALL);
            mCount = a.getInt(R.styleable.ShareViewHorizontal_socialViewAndroid_count, 0);
            mCountFormat = a.getInt(R.styleable.ShareViewHorizontal_socialViewAndroid_countFormat, COUNT_FORMAT_SHORT);
        ...
        iconImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mOnClickToggle) ShareViewHorizontal.this.toggle();
                if (null != mListener) mListener.onClicked(ShareViewHorizontal.this);
            }
        });
    ...
    public ShareViewHorizontal setCount(long count) {
        this.mCount = count;
        countTextView.setText(formattedCount());
        return this;
    }
