 ...
 */
public class CommentViewVertical extends LinearLayout {
    ...
    public interface OnClickListener {
        void onClicked(CommentViewVertical view);
    }

    private OnClickListener mListener;

    public CommentViewVertical(Context context) {
        this(context, null);
    }

    public CommentViewVertical(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CommentViewVertical(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        LayoutInflater.from(context).inflate(R.layout.social_view_android_comment_view_vertical, this);
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.CommentViewVertical,0, 0);
        try {
            //mLikeDrawableSrc = a.getDrawable(R.styleable.LikeCountView_likeDrawableSrc);
            mTextColor = a.getColorStateList(R.styleable.CommentViewVertical_socialViewAndroid_textColor);
            mIconSrc = a.getResourceId(R.styleable.CommentViewVertical_socialViewAndroid_iconSrc, -1);
            mCommentedIconSrc = a.getResourceId(R.styleable.CommentViewVertical_socialViewAndroid_commentedIconSrc, -1);
            mIconFilterColor = a.getColorStateList(R.styleable.CommentViewVertical_socialViewAndroid_iconFilterColor);
        ...
        iconImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mOnClickToggle) CommentViewVertical.this.toggle();
                if (null != mListener) mListener.onClicked(CommentViewVertical.this);
            }
        });
    ...
    public CommentViewVertical setCount(long count) {
        mCount = count;
        countTextView.setText(formattedCount());
        return this;
    }
